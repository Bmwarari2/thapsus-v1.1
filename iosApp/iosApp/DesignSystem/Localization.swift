...
private enum Strings {
    static let en: [String: String] = [
        ...
        "home.step1.body": "Shop any brand in the UK or China. Use our warehouse address as yours.",
    ...
    static let sw: [String: String] = [
        ...
        "home.step1.body": "Nunua bidhaa yoyote UK au China. Tumia anwani yetu ya ghala kama yako.",
